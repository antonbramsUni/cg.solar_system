...
void ApplicationSolar::render() const {
  // iterator on the struct planets
  // while passing the planet model pointer in the 
  // "upload_planet_transforms" method
